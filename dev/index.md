...
This will execute a resampling or tuning function over the workflows in
the `workflow` column:
...
method shows the rankings of the workflows:
...
![](reference/figures/README-plot-best-1.png)
